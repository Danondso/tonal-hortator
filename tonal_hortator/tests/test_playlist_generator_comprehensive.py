...
class TestLocalPlaylistGeneratorComprehensive(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_embedding_service.get_embeddings_batch.return_value = [[0.1] * 384] * 10
        self.mock_embedding_service.similarity_search.return_value = []
        self.mock_embedding_service.create_track_embedding_text.return_value = "test track text"
    ...
    def test_init_with_defaults(self, mock_artist_distributor, mock_deduplicator, 
                               mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        mock_track_embedder.assert_called_with(self.temp_db.name, embedding_service=self.mock_embedding_service)
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_init_with_custom_model(self, mock_artist_distributor, mock_deduplicator, 
                                   mock_query_processor, mock_track_embedder, mock_embedding_service):
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_generate_playlist_success(self, mock_artist_distributor, mock_deduplicator, 
                                      mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        self.mock_artist_distributor.apply_artist_randomization.return_value = mock_results
        
        generator = LocalPlaylistGenerator(self.temp_db.name)
        result = generator.generate_playlist("test query", max_tracks=10, min_similarity=0.3)
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_generate_playlist_no_embeddings_initial(self, mock_artist_distributor, mock_deduplicator, 
                                                    mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        self.mock_track_embedder.get_all_embeddings.side_effect = [
            ...
            ([[0.1] * 384] * 3, [{"id": i, "name": f"Track {i}"} for i in range(3)])  # Second call
        ]
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_generate_playlist_no_embeddings_after_embedding(self, mock_artist_distributor, mock_deduplicator, 
                                                            mock_query_processor, mock_track_embedder, mock_embedding_service):
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_generate_playlist_exception_handling(self, mock_artist_distributor, mock_deduplicator, 
                                                 mock_query_processor, mock_track_embedder, mock_embedding_service):
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_extract_playlist_parameters_with_count(self, mock_artist_distributor, mock_deduplicator, 
                                                   mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        self.mock_track_embedder.get_all_embeddings.return_value = ([[0.1] * 384] * 5, [{"id": i} for i in range(5)])
        self.mock_embedding_service.similarity_search.return_value = []
        self.mock_deduplicator.deduplicate_tracks.return_value = []
        self.mock_artist_distributor.apply_artist_randomization.return_value = []
        ...
        self.mock_query_processor.extract_track_count.assert_called_with("15 tracks of rock music")
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_filter_by_artist_with_artist(self, mock_artist_distributor, mock_deduplicator, 
                                         mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        mock_results = [
            {"id": 1, "name": "Bohemian Rhapsody", "artist": "Queen", "similarity_score": 0.8},
            {"id": 2, "name": "Stairway to Heaven", "artist": "Led Zeppelin", "similarity_score": 0.7},
            {"id": 3, "name": "We Will Rock You", "artist": "Queen", "similarity_score": 0.6},
        ]
        self.mock_embedding_service.similarity_search.return_value = mock_results
        ...
        self.mock_query_processor.extract_artist_from_query.assert_called_with("songs by Queen")
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_apply_genre_filtering_with_genre(self, mock_artist_distributor, mock_deduplicator, 
                                             mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        mock_results = [
            {"id": 1, "name": "Rock Song", "artist": "Rock Artist", "genre": "rock", "similarity_score": 0.8},
            {"id": 2, "name": "Jazz Song", "artist": "Jazz Artist", "genre": "jazz", "similarity_score": 0.7},
            {"id": 3, "name": "Rock Song 2", "artist": "Rock Artist 2", "genre": "rock", "similarity_score": 0.6},
        ]
        self.mock_embedding_service.similarity_search.return_value = mock_results
        ...
        self.mock_query_processor.extract_genre_keywords.assert_called_with("rock music")
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_apply_genre_filtering_no_genre(self, mock_artist_distributor, mock_deduplicator, 
                                           mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        # Check that genre keywords were extracted
        self.mock_query_processor.extract_genre_keywords.assert_called_with("happy music")
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_process_and_refine_playlist_vague_query(self, mock_artist_distributor, mock_deduplicator, 
                                                    mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        self.mock_artist_distributor.apply_artist_randomization.assert_called_with(mock_results, 20, True)
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_process_and_refine_playlist_specific_query(self, mock_artist_distributor, mock_deduplicator, 
                                                       mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        self.mock_artist_distributor.apply_artist_randomization.assert_called_with(mock_results, 20, False)
    ...
    @patch('tonal_hortator.core.playlist_generator.TrackDeduplicator')
    @patch('tonal_hortator.core.playlist_generator.ArtistDistributor')
    def test_generate_playlist_custom_parameters(self, mock_artist_distributor, mock_deduplicator, 
                                                mock_query_processor, mock_track_embedder, mock_embedding_service):
        ...
        generator = LocalPlaylistGenerator(self.temp_db.name)
        result = generator.generate_playlist("test query", max_tracks=50, min_similarity=0.5)
        
        # Check that custom parameters were used
        self.mock_deduplicator.deduplicate_tracks.assert_called_with(mock_results, 0.5, 50)
        self.mock_artist_distributor.apply_artist_randomization.assert_called_with(mock_results, 50, False)
